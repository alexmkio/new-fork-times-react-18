describe("Dashboard View", () => {
  ...
  it("There is a dropdown with sort options", () => {
    cy.get("select")
      .select("Published - ascending")
      .should("have.value", "pubAsc")
      .get("select")
      .select("Published - descending")
      .should("have.value", "pubDesc")
      .get("select")
      .select("Updated - ascending")
      .should("have.value", "upAsc")
      .get("select")
      .select("Updated - descending")
      .should("have.value", "upDesc");
  });
